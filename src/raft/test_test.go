...
func TestBackup2B(t *testing.T) {
	...
	// leader_t := cfg.checkOneLeader()
	// fmt.Println("leader_t", leader_t)

	// fmt.Println("leader", leader1, cfg.rafts[leader1].commitIndex, len(cfg.rafts[leader1].logs))
	// fmt.Println("leader+1", leader1+1, cfg.rafts[(leader1+1)%servers].commitIndex, len(cfg.rafts[(leader1+1)%servers].logs))
	// fmt.Println("other", other, cfg.rafts[other].commitIndex, len(cfg.rafts[other].logs))
	...
	// fmt.Println("commitIndex6", cfg.rafts[leader1].commitIndex)
